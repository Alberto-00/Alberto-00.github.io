document.addEventListener('DOMContentLoaded', () => {
    ...
    const ctx = document.getElementById('certificationsRadar').getContext('2d');
        ...
        datasets: [
            {
                ...
                fill: true,
                backgroundColor: 'rgba(0, 124, 237, 0.2)',
                borderColor: 'rgba(0, 124, 237, 1)',
                pointBackgroundColor: 'rgba(0, 124, 237, 1)',
